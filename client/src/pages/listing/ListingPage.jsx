                    ...
                    <div className="bg-white">
                        ...
                        <div className="mt-4 flex justify-between gap-4">
                            ...
                            <div className="rounded-md py-4 border-b ">
                                    <h2 className="font-semibold text-xl py-2">About this jetski</h2>
                                    {listing.description}
                                </div>
                                <div className="rounded-md py-4 border-b">
                                    <h2 className="font-semibold text-xl py-2">This you should know</h2>
                                        <div className="grid grid-cols-3">
                                            <div> Check-in: <br /> {listing.checkIn}</div>
                                            <div> Check-out:<br /> {listing.checkOut}</div>
                                            <div> Capacity:<br /> {listing.maxGuests}
                                        </div>
                                    </div>
                                </div>
                                <div className="rounded-md py-4 border-b">
                                    <h2 className="font-semibold text-xl py-2">This accommodation offers that</h2>
